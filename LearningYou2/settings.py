"""
Django settings for LearningYou2 project.
...
SECRET_KEY = 'django-insecure-2g=s8=-l(sw3yvgvvazgemc)a0p&la*sdkk6(vo&-ykkq&gza&'
...
WSGI_APPLICATION = 'LearningYou2.wsgi.application'
